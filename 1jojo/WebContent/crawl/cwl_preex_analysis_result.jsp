...
<c:if test="${search_list_count > 0 }">
	...
	<tr align="center" valign="middle">
		<td colspan="4">
			<button type="button" class="btn btn-default" >우대사항 분석결과</button>
			<button type="button" class="btn btn-default" onclick="location.href='./CrawlAnalysisAction.cr'">우대사항 포함 업체 리스트</button>
